...
import static Playground.mastermind.Code.CODE_SIZE;
...
//        }
        ...
        count = (int) Stream.iterate(0, n -> n + 1)
                .limit(CODE_SIZE)
    ...
    public String toString() {
        return String.format("%s, OK: %d, MISS: %d", guess.getCode(), numberGuessed(), numberMissed());
    }
}
